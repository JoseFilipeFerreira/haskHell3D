...
heart :: Picture
heart = Scale 20 20 $ Pictures [ outline, r1, r2, r3, r4, r5]
    where
        ...
        outline = Pictures [ Translate 6  0 bP
                           , Translate 5  1  bP
                           , Translate 7  1  bP
                           , Translate 4  2  bP
                           , Translate 8  2  bP
